...
from src.views import get_greeting, get_last_digits, get_total_spent, get_cashback, get_top_5_by_spent
...
def test_get_top_5_by_spent(testing_transactions):
    assert get_top_5_by_spent(testing_transactions) == [{'amount': -3089.97,
